...
<!-- FAVICON -->
  ...
  <body id="<?php if (is_front_page()) { echo 'home-page'; } elseif (is_home()) { echo 'the-latest-page'; } elseif (is_single()) { echo 'blog-post-page'; } else { echo $post->post_name . "-page"; } ?>" <?php body_class(); ?>>
