...
jQuery(document).ready(function($) {
  ...
  if (mediaQuerySmall.matches) {
    ...
    $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"top": -113.5});
    // $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"margin-bottom": rowMarginMobile});
    $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"margin-bottom": -113.5});
  } else if (mediaQueryMedium.matches) {
    // window width is less than 1025px
    ...
    $("#dog-adoption-page .project-desktop-mockups-section").css({"margin-bottom": 1168.5});

    // $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"top": laptopPosition});
    $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"top": -110.5});
    // $("#dog-adoption-page .project-desktop-mockups-section__row--second").css({"margin-top": rowMargin});
    $("#dog-adoption-page .project-desktop-mockups-section__row--second").css({"margin-top": 110.5});
  } else {
    // window width is at least 1025px
    $("#dog-adoption-page .project-desktop-mockups-section__border").css({"height": borderHeight});
    // $("#dog-adoption-page .project-desktop-mockups-section").css({"margin-bottom": desktopMockupsSectionHeight});
    $("#dog-adoption-page .project-desktop-mockups-section").css({"margin-bottom": 1691});

    // $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"top": laptopPosition});
    $("#dog-adoption-page .project-desktop-mockups-section__row--first").css({"top": -207.5});
    // $("#dog-adoption-page .project-desktop-mockups-section__row--second").css({"margin-top": rowMargin});
    $("#dog-adoption-page .project-desktop-mockups-section__row--second").css({"margin-top": 207.5});
  }
